...
To keep things simple I have created in memory repository with few saved items. To start using simply download, open the solution and run. 
...
Customer and product aleady exists, so feel free just to call these urls.
